...
- **Backtesting engine** – Run discrete trade simulations with configurable cash, point value, tick value, and optional forced exits on the final bar. Results include trade logs, equity curves, and summary metrics displayed directly in the interface.
